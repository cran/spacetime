...
print(stplot(nct[,,"SID"], par.strip.text = list(cex=.5)))
@
\end{center}
...
time = xts(1:17, as.POSIXct(paste(1970:1986, "-01-01", sep="")))
# deselect district of columbia, polygon 8, not present in Produc:
